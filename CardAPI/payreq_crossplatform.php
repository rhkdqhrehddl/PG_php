...
header('Set-Cookie: PHPSESSID='.session_id().'; SameSite=None; Secure');
    ...
    $LGD_SELF_CUSTOM    = $_POST["LGD_SELF_CUSTOM"];                             //표준창의 신용카드 선택창 스킵
    $LGD_CARDTYPE          = $_POST["LGD_CARDTYPE"];                            //결제진행 신용카드 카드사 코드
    $LGD_INSTALL                 = $_POST["LGD_INSTALL"];                            //안심클릭할부개월
    $LGD_NOINT                    = $_POST["LGD_NOINT"];                            //무이자적용 여부
