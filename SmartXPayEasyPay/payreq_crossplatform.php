<?php
	...
	$LGD_INSTALLRANGE			= $_POST["LGD_INSTALLRANGE"];					//할부개월
	$LGD_USABLECARD				= $_POST["LGD_USABLECARD"];						//결제 신용카드
	$LGD_EASYPAY_ONLY           = $_POST["LGD_EASYPAY_ONLY"];					//paynow 사용여부
	$LGD_MONEPAY_AUTORUNYN      = $_POST["LGD_MONEPAY_AUTORUNYN"];				//paynow 자동구동 여부
     ...
     */    
    $LGD_RETURNURL				= "https://" . $server_domain . "/SmartXPayEasyPay/returnurl.php";  
	...
	*/
    ...
    $payReqMap['LGD_VERSION']         		= "PHP_Non-ActiveX_SmartXPay_Paynow";	// 사용타입 정보(수정 및 삭제 금지): 이 정보를 근거로 어떤 서비스를 사용하는지 판단할 수 있습니다.
